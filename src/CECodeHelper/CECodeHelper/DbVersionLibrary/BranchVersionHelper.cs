...
namespace DbVersionLibrary
{
    public class BranchVersionHelper
    {
        ...
        {
            var startVer = new Version(CECodeHelper.Properties.Resources.StartVersion);
            var versionStartDate = DateTime.Parse(CECodeHelper.Properties.Resources.StartDate);
            var sprintCountPerMinorVersion = Int32.Parse(CECodeHelper.Properties.Resources.SprintCountPerVersion);
            var sprintLengthDays = Int32.Parse(CECodeHelper.Properties.Resources.SprintLengthDays);
